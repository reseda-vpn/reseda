...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((windowName, options) => {
  ...
  const browserOptions = _objectSpread(_objectSpread(_objectSpread({}, options), state), {}, {
    icon: path__WEBPACK_IMPORTED_MODULE_13___default().join(__dirname, "resources", "icon_small.ico"),
...
var $ = __webpack_require__(/*! ../internals/export */ "./node_modules/core-js-pure/internals/export.js");
var DESCRIPTORS = __webpack_require__(/*! ../internals/descriptors */ "./node_modules/core-js-pure/internals/descriptors.js");
var objectDefinePropertyModule = __webpack_require__(/*! ../internals/object-define-property */ "./node_modules/core-js-pure/internals/object-define-property.js");
...
/***/ "wireguard-tools":
/*!**********************************!*\
  !*** external "wireguard-tools" ***!
  \**********************************/
/***/ ((module) => {

"use strict";
module.exports = require("wireguard-tools");
...
/* harmony import */ var sudo_prompt__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! sudo-prompt */ "sudo-prompt");
/* harmony import */ var sudo_prompt__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(sudo_prompt__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helpers */ "./main/helpers/index.ts");
/* harmony import */ var wireguard_tools__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! wireguard-tools */ "wireguard-tools");
...
function createTray(mainWindow) {
  let appIcon = new electron__WEBPACK_IMPORTED_MODULE_2__.Tray(path__WEBPACK_IMPORTED_MODULE_4___default().join(process.cwd(), './', 'resources/icon_small.ico'));
...
electron__WEBPACK_IMPORTED_MODULE_2__.app.on('ready', async () => {
  ...
  try {
    fs__WEBPACK_IMPORTED_MODULE_5___default().closeSync(fs__WEBPACK_IMPORTED_MODULE_5___default().openSync(firstTimeFilePath, 'wx'));
    isFirstTime = true;
  } catch (e) {
    if (e.code === 'EEXIST') {
      console.log(e);
...
const ex = (command, with_sudo, callback) => {
  if (with_sudo) {
    sudo_prompt__WEBPACK_IMPORTED_MODULE_6___default().exec(command, {
    ...
    (0,child_process__WEBPACK_IMPORTED_MODULE_9__.exec)(command, (_, __, err) => {
      if (err) throw err;
      callback(__);
    });
  }
